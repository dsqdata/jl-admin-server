...
function getcsUrl(t, o) {
    ...
    if (o == 1) {
        css.attr({rel: "stylesheet", type: "text/css", href: t + 'css1.css'});
    } else if (o == 2) {
        css.attr({rel: "stylesheet", type: "text/css", href: t + 'css2.css'});
    } else if (o == 3) {
        css.attr({rel: "stylesheet", type: "text/css", href: t + 'css3.css'});
    } else if (o == 4) {
        css.attr({rel: "stylesheet", type: "text/css", href: t + 'css4.css'});
    } else if (o == 5) {
        css.attr({rel: "stylesheet", type: "text/css", href: t + 'css5.css'});
    }
}

var Objarr = [];
var ObjControlIndex = {index: 0};
(function () {
    var dmm = function (options1) {
        $("#" + options1.container + "").html("");
        var page = "<div class='w-btn-group x-pages-f' id='" + options1.container + "_page'></div>";
        var options = $.extend({
            index: 1, container: "", callback: function () {
            }, size: [10, 20], skip: false, cssStyle: 1, setSize: false
        }, options1);
