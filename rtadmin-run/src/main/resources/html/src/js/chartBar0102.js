...
var myChart102 = echarts.init(document.getElementById('chartBar0102'));
function chartBar0102(rq2,lx2fgl,lx2fgs){
    var x_data = rq2,
        bar_data = lx2fgs,
        line_data = lx2fgl,
    option = {
