package com.ratel.modules.jladmin.respository;
...
@Repository
public interface TestRepository extends BaseRepository<TestDomain, Long> {


    //-------jpql查询--------

    //根据用户id和firstName查询
    @Query(value = "from TestDomain where id = ?2 and firstName = ?1")
    TestDomain findUserByIdAndName(String username, int id);
