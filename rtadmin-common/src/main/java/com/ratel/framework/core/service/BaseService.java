...
import com.ratel.framework.core.domain.AbstractPersistableEntity;
import com.ratel.framework.core.domain.BaseNativeNestedSetEntity;
import com.ratel.framework.core.pagination.ExtPageRequest;
import com.ratel.framework.core.pagination.GroupPropertyFilter;
import com.ratel.framework.core.pagination.JsonPage;
...
public abstract class BaseService<T extends AbstractPersistableEntity, ID extends Serializable> {
    ...
    public <X extends Persistable> List<X> findByFilters(Class<X> clazz, GroupPropertyFilter groupPropertyFilter, Sort sort) {
        ...
        return ((BaseRepository) spec).findAll(spec, sort);
    }
    ...
    private <X extends Persistable> Specification<X> buildSpecification(final GroupPropertyFilter groupPropertyFilter) {
        if (BaseNativeNestedSetEntity.class.isAssignableFrom(entityClass)) {
            ...
            groupPropertyFilter.forceAnd(new PropertyFilter(PropertyFilter.MatchType.NE, "depth", 0));
        }
