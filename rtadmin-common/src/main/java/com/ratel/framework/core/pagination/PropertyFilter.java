...
import com.ratel.framework.utils.reflection.ConvertUtils;
...
//                    propertyClass = LocalDateTime.class;
    ...
    private Object parseMatchValueByClassType(Class propertyClass, String value) {
        ...
        if (Enum.class.isAssignableFrom(propertyClass)) {
            ...
            return DateUtils.parseDate(value, DateUtils.DEFAULT_TIME_FORMAT);
            //return LocalDate.parse(value, LocalDateSerializer.LOCAL_DATE_FORMATTER);
//        }
//        else if (propertyClass.equals(LocalDate.class)) {
//            return DateUtils.parseDate(value, DateUtils.DEFAULT_DATE_FORMAT);
//            //return LocalDate.parse(value, LocalDateSerializer.LOCAL_DATE_FORMATTER);
...
//            return DateUtils.parseDate(value, DateUtils.DEFAULT_DATE_FORMAT);
    ...
    public static Sort buildSortFromHttpRequest(HttpServletRequest request) {
        String sidx = StringUtils.isBlank(request.getParameter("sortField")) ? "id" : request.getParameter("sortField");
        Direction sord = "ascend".equalsIgnoreCase(request.getParameter("sortOrder")) ? Direction.ASC : Direction.DESC;
        Sort sort = null;
