...
public class TokenProvider implements InitializingBean {
   ...
   public TokenProvider(SecurityProperties properties, UserDetailsService userDetailsService) {
   ...
   Authentication getAuthentication(String token, OnlineUser onlineUser) {
