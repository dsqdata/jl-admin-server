...
import com.ratel.modules.mnt.repository.DeployRepository;
import com.ratel.modules.mnt.service.dto.DeployQueryCriteria;
import com.ratel.modules.mnt.util.ExecuteShellUtil;
import com.ratel.modules.mnt.util.ScpClientUtil;
...
public class DeployService extends BaseService<Deploy, Long> {
    ...
    public Deploy create(Deploy resources) {
        return deployRepository.save(resources);
    }
    ...
    private ExecuteShellUtil getExecuteShellUtil(String ip) {
        ServerDeploy serverDeployDTO = serverDeployService.findByIp(ip);
    ...
    public void download(List<Deploy> queryAll, HttpServletResponse response) throws IOException {
        List<Map<String, Object>> list = new ArrayList<>();
        for (Deploy deployDto : queryAll) {
